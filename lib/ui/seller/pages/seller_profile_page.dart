      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          CircleAvatar(
            ...
            child: Text(user?.firstName.isNotEmpty == true ? user!.firstName[0].toUpperCase() : 'S', style: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Color(0xFF0F2850))),
          ),
          ...
          Container(
            ...
            child: const Text('SELLER', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Color(0xFF0F2850))),
          ),
